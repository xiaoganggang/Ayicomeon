    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnRegistered:
                ...
                final String phoen = et_phone.getText().toString().trim();

                //判断是否为空
                if (!TextUtils.isEmpty(name) & !TextUtils.isEmpty(age) &
                        !TextUtils.isEmpty(pass) &
                        !TextUtils.isEmpty(password) &
                        !TextUtils.isEmpty(phoen)) {
                        ...
                        user.signUp(new SaveListener<MyUser>() {
                            ...
                            public void done(MyUser myUser, BmobException e) {
                                if (e == null) {
                                    ...
                                    //在这里把这些信息缓存了
                                    ShareUtils.putString(RegisteredActivity.this, "姓名", name);
                                    ShareUtils.putString(RegisteredActivity.this, "年龄", age);
                                    ShareUtils.putString(RegisteredActivity.this, "手机号", phoen);
                                    finish();
                                } else {
